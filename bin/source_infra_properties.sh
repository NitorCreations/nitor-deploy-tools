...
usage() {
  ...
  echo "  component             the component directory to look for additional properties files" >&2
  echo "  stack-or-docker-name  the stack or docker directory to look for more properties files" >&2
  echo "" >&2
